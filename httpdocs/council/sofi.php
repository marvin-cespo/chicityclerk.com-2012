...
$sofi_query = sprintf("SELECT * FROM councilSofi");
$sofi_result = mysql_query($sofi_query);
...
<head>
<title>Financial Disclosures | Office of the City Clerk, City of Chicago</title>
				...
				<div class="row">
					...
					<div id="right-column" class="span9">
						<div class="interior-content">
							<article id="content">
								<div id="post-234">
									<h2 class="entry-title">Financial Disclosures</h2>
									<div class="entry-content">
										<p>
											Pursuant to Section 2-156-150 of the Municipal Code, each Alderman is required to file a Statement of Financial Interest with the City Clerk. These statements are open to public inspection and contain information regarding the reporting individual&rsquo;s financial interest which:
										</p>
										<ul>
											<li>entitles the owner to income in excess of $2,500,</li>
											<li>has a cost or present value in excess of $5,000, or</li>
											<li>represents more than 10% of corporation, partnership, sole partnership, firm, enterprise, franchise, organization, holding company, joint stock company, receivership, trust, or any legal entity organized form profit.</li>
										</ul>
										<p>Statements must be filed by an Alderman at the time of filing his oath of office and then annually thereafter. The deadline for filing statements is May 1 with a late fee assessed for statements filed after the deadline. Failure to file statements by May 31 constitutes a violation of the Chapter 2-156-190(a) of the Municipal Code.</p>										
										<table class="table table-bordered table-striped table-condensed" id="datatable">
											...
											<tbody>
												<?php
													...
													while ( $sofi = mysql_fetch_object($sofi_result) ) :
									
													?>
													<tr>
														<td><?php echo $sofi->sofiYear;?></td>
														<td><?php echo $sofi->sofiWard;?></td>
														<td><?php echo $sofi->sofiAlderman;?></td>
														<td class="download"><a class="btn btn-block btn-primary" href="<?php echo $sofi->sofiURL;?>" target="_blank">Download</a></td>
													</tr>
													<?php
													endwhile;
												?>
