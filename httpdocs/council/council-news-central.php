		...
		<div class="row">
			<div class="span12">
				...
				<div id="cnc-banner">
					...
					<p class="banner-bottom">Council will meet Wednesday, June 25, 2014 at 10a.m.<a href="https://chicago.legistar.com/Calendar.aspx" target="_blank">Visit the LIC to view prior meetings</a>.</p>
				</div>
				<div id="quick-links">
					<table style="width: 100%;">
						<tbody>
							<tr>
								...
								<td style="width: 20%; padding: 5px;"><a class="btn btn-danger btn-block btn-large" href="https://chicago.legistar.com/MeetingDetail.aspx?ID=312943&GUID=0268BCB3-22F8-4772-8255-5FF1F0E1C706&Options=&Search=" target="_blank">Meeting Agenda</a></td>
